...
check(wait(lambda: any(h.get("type") == "request_texture" for h, _ in nomad.received)),
      "an unknown texture_id is requested (section 10.2)")
...
for name in ("material", "light", "camera_object", "texture", "display_config"):
